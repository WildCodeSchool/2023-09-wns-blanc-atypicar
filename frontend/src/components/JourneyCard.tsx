      ...
      <div className="flex flex-col justify-between items-center p-2 h-52">
        <div className="flex flex-col md:flex-row">
          ...
          <CardHeader className="grid grid-cols-[60px_20px_minmax(0,_1fr)] justify-items-start font-bold font-montserrat w-52">
            ...
            <h4
              className={`whitespace-nowrap overflow-hidden max-w-[8ch] md:max-w-[11ch] ${journey.startingPoint.length > 8 ? "fade-out" : ""} md:${journey.startingPoint.length > 11 ? "fade-out" : ""}`}
            >
            ...
            <div className="w-3 h-3 border-solid border-2 border-black rounded-full"></div>
            <h4
              className={`whitespace-nowrap overflow-hidden max-w-[8ch] md:max-w-[11ch] ${journey.arrivalPoint.length > 8 ? "fade-out" : ""} md:${journey.arrivalPoint.length > 11 ? "fade-out" : ""}`}
            >
